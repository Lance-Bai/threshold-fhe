...
// use tfhe::{boolean::prelude::{DecompositionBaseLog, DecompositionLevelCount}, core_crypto::{commons::math::decomposition::{SignedDecompositionIter, SignedDecompositionNonNativeIter, ValueSign}, prelude::{CiphertextModulus, UnsignedInteger}}, prelude::CastInto};
...
// #[derive(Debug)]
// pub struct LocalSignedDecomposer<Scalar>
// where
...
// impl<Scalar> LocalSignedDecomposer<Scalar>
// where
//     Scalar: UnsignedInteger,
// {
...
//     ///
//     /// ```rust
//     /// use tfhe::core_crypto::commons::math::decomposition::LocalSignedDecomposer;
//     /// use tfhe::core_crypto::commons::parameters::{DecompositionBaseLog, DecompositionLevelCount};
//     /// let decomposer =
//     ///     LocalSignedDecomposer::<u32>::new(DecompositionBaseLog(4), DecompositionLevelCount(3));
...
//             "Decomposed bits exceeds the size of the integer to be decomposed with"
//         );
//         Self {
//             base_log: base_log.0,
...
//             this is not supported, use LocalSignedDecomposer instead"
//         );
